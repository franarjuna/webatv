...
foreach($unidades->result() as $rss){
	echo "unidades.push({codigo:'".$rss->unidad_codigo."',tipo:'',ambientes:'".$rss->unidad_ambientes."',superficie:'".$rss->unidad_superficie."',piso:'".$rss->unidad_piso."'});";
}
//echo "console.log(unidades);";
?>
</script>
