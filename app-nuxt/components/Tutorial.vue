...
<template>
  <div
    class="relative flex items-top justify-center min-h-screen bg-gray-100 lg:items-center lg:pt-0"
  >
    <link
      href="https://cdn.jsdelivr.net/npm/tailwindcss@2.1.2/dist/tailwind.min.css"
      rel="stylesheet"
    />
    <div class="max-w-4xl mx-auto lg:px-6 lg:px-8">
      <a
        class="flex justify-center pt-8 lg:pt-0"
      ...
      <div class="mt-8 bg-white overflow-hidden shadow lg:rounded-lg p-6">
