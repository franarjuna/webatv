    ...
    <div class="row d-none d-md-flex">
        ...
        <div class="col-md-5  developers text-left">
          <div class="logosfot">
            ...
            <?php /*<img src="<?php echo base_url();?>assets/img/logos/Leed-04.svg" style="height:29px" >
...
<div id="modal-360" class="modal-view">
	<div class="">
		<div class="close-view" data-modal="modal-360"><img src="assets/img/close.png" alt=""></div>
...
<?php if(isset($haygmapa) && $haygmapa==1){?>
...
var uluru = {lat: -34.5831607, lng: -58.4354965}; 
  ...
  document.getElementById('map'), {zoom: 16, center: uluru,
      styles: [
        ...
        {"featureType": 'poi',"stylers": [{"visibility": 'off'}]},
         /*{"featureType": 'poi.business.restaurant',"stylers": [{"visibility": 'on' }]},
       {"featureType": "poi.business.restaurant","elementType": "labels.icon","stylers": [{"color": "#3a4762"}]},
        {"featureType": 'poi.business.restaurant',"stylers": [{"visibility": 'on',"color": "#fff" }]},*/
    ...
    setTimeout($.ajax(
            {
                ...
                data : {
                    ...
                    subject: "Consulta SENS HUMBOLDT",
