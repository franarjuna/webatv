...
$ch = curl_init("http://adm.atvarquitectos.com/unidad/".$unidad);
...
$uni = json_decode($server_output);
$info = $uni->info;
$plano = $uni->plano;
$plano2 = $uni->plano2;
$plano3 = $uni->plano3;
$unidad = substr($unidad,1);
?>
<div class="row">
    <div class="col-md-2 unidaddetail">
        ...
        <?php }?>
        <?php if ($info->unidad_360 != ''){?>
            <a data-urlview='<?php echo $info->unidad_360;?>' class='bt360 logo-360 mb-4'><svg version='1.1' class='logo-360-svg' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 77.1 77.1' style='enable-background:new 0 0 77.1 77.1;' xml:space='preserve'>
                  <style type='text/css'>
                    .st0{fill:#ffffff;}
                    .st1{fill: #445f82;}
                  </style>
