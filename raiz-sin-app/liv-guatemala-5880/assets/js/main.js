    ...
    if (departamento !== undefined) {
        ...
        for(var i = 1; i <= images; i++){
           ...
           if (i == images && view360) {
            ...
            var url3603 = (departamento['url3603'] !== undefined) ? departamento['url3603']: '';
            var url3604 = (departamento['url3604'] !== undefined) ? departamento['url3604']: '';
            var url3605 = (departamento['url3605'] !== undefined) ? departamento['url3605']: '';
            ...
            var iframe3 = (url3603 != '') ? '<iframe src="'+url3603+'" class="iframe" width="100%" height="700"></iframe>': false;
            var iframe4 = (url3604 != '') ? '<iframe src="'+url3604+'" class="iframe" width="100%" height="700"></iframe>': false;
            var iframe5 = (url3605 != '') ? '<iframe src="'+url3605+'" class="iframe" width="100%" height="700"></iframe>': false;
            ...
            html += (iframe3) ? '<li data-thumb="assets/img/departamentos/'+ directory +'/thumb/360_3.jpg" >'+iframe3+'</li>': '';
            html += (iframe4) ? '<li data-thumb="assets/img/departamentos/'+ directory +'/thumb/360_4.jpg" >'+iframe4+'</li>': '';
            html += (iframe5) ? '<li data-thumb="assets/img/departamentos/'+ directory +'/thumb/360_5.jpg" >'+iframe5+'</li>': '';
           }else{
            html += '<li data-thumb="assets/img/departamentos/'+ directory +'/thumb/'+i+'.jpg" ><img src="assets/img/departamentos/'+ directory +'/'+i+'.'+extension+'" alt="" /></li>';
           }
        } 
...
function initMap(){
    ...
    var latlng =  {lat: -34.578210, lng: -58.434870};
