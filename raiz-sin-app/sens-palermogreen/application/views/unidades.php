...
foreach($unidades->result() as $rss){
	echo "unidades.push({codigo:'".$rss->unidad_codigo."',tipo:'',ambientes:'".$rss->unidad_ambientes."',reservada:'".$rss->reservada."',superficie:'".$rss->unidad_superficie."',piso:'".$rss->unidad_piso."',pileta:'".$rss->unidad_pileta."',activa:0,amb:0,sup:0,tipo:0});";
}
?> 
</script>
