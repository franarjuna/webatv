...
<script>
  ...
  form.validate({
    submitHandler: function() {
      ...
      setTimeout($.ajax({
        url: 'https://www.atvarquitectos.com/send.php',
        type: "POST",
        data: {
          from: $('[name="email"]').val(),
          ...
          <?php if (isset($_SESSION['utm_source'])) { ?>,
            utm_source: "<?php echo $_SESSION['utm_source']; ?>",
            utm_medium: "<?php echo $_SESSION['utm_medium']; ?>",
            utm_campaign: "<?php echo $_SESSION['utm_campaign']; ?>",
            utm_term: "<?php echo $_SESSION['utm_term']; ?>",
            utm_content: "<?php echo $_SESSION['utm_content']; ?>"
          <?php } ?>
        },
