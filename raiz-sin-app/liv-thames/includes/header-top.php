    ...
    <div class="content-header">
        <div class="ed-container header-top full">
            <div class="ed-item s-40">
                <h1 class="logo">
                    <img class="img-responsive" src="assets/img/Liv-thames-logo.svg" />
                </h1>
            </div>
            <div class="ed-item s-60 relative">
                <div class="txtright">
                    <a class="tel btn" href="tel:+5491140960600">+5411 4096 0600 &nbsp;&nbsp;<?php echo file_get_contents("assets/img/phone.svg"); ?></a>
      							<?php /*<a class="" href="https://wa.me/5491151745074?text=Hola. Quisiera recibir más información sobre Liv Thames" target="_blank" style="float:right;margin-left: 20px;"><img src="https://img.icons8.com/color/300/000000/whatsapp.png" style="width:40px;"/></a>*/?>
                </div>
        ...
        <div class="text-video" id="text-video">
            <div >
                <h2 class="uppercase"><span class="book">VIVÍ LIBRE, VIVÍ BIEN,<br>VIVÍ LIV.</span></h2>
                <p>
                    Disfrutá tu propio mundo.<br>
                    Donde los pequeños placeres cotidianos<br>
                    construyen una vida plena.
                </p>
                <div>
