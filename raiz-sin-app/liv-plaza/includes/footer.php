<footer class="site-footer">
        ...
        <div class="ed-item row-small-2 ed-container">
            <div class="ed-item l-40 ed-container footer-logo">
                ...
                <div class="ed-item footer-logos-footer only-desktop ed-container">
                    <div class="ed-item">
                        <img class="img-responsive atv-logo" src="assets/img/l-ATV-apellidos.svg" />
                        <img class="img-responsive" src="assets/img/l-logo_ocampo.svg" />
                    </div>
                </div>
            </div>
            <div class="ed-item l-60 footer-desc">
                <h2 class="heading"><span class="light">VIVÍ TODAS LAS POSIBILIDADES</span > <br>VIVÍ LIV PLAZA.</h2><br>
                <p>Liv Plaza está pensado para que vivas de forma descontracturada, con espacios que se adaptan a los distintos momentos de tu vida. Un lugar diseñado para que vivas bien.
                </p>
                ...
                <div class="form-container">
                    ...
                    <div class="input input-fifty">
                        ...
                        <div class="txtright relative">
                            ...
                            <button type="submit" class="button-submit btn">Enviar<span class="arrow-right"></span>
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="footer-logos mobile-tablet">
                ...
                <div>
                    <img class="img-responsive" src="assets/img/l-ATV-apellidos.svg" />
                    <img class="img-responsive" src="assets/img/l-logo_ocampo.svg" />
                </div>
            </div>
        </div>
    ...
    <div class="footer-bottom ed-container full no-padding" id="contact">
        <div class="row-small-2 ed-item ed-container">
            <div class="ed-item s-90 m-75 l-70 copyright">
            ...
            <div class="ed-item s-10 m-25 l-30 social main-end">
                <ul>
